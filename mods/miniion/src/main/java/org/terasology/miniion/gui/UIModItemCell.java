...
import org.terasology.rendering.gui.widgets.UIItemCell.UIItemCellIcon;
 ...
 * @see PlayerComponent
 */
public class UIModItemCell extends UIDisplayContainer  {
    ...
    private MouseButtonListener mouseButtonListener = new MouseButtonListener() {        
        ...
        public void wheel(UIDisplayElement element, int wheel, boolean intersect) {
            if (intersect) {
                ...
                if (wheel > 0) {
                    moveItem(UIModItemCell.this, amount, false, false);
                }
                //get item from transfer slot
                else {
                    sendToTransferSlot(UIModItemCell.this, amount);
                }
                ...
                /*if (ownerEntity.getComponent(InventoryComponent.class) != null) {
                    ...
                    if (button == 0) {
                        ...
                        if (getFromTransferSlot().exists()) {
                            ...
                            moveItem(UIModItemCell.this, (byte) 0, true, true);
                        ...
                        //drag
                            ...
                            //move item to the transfer slot
                            sendToTransferSlot(UIModItemCell.this, (byte) 0);
                    ...
                    //right click
                        ...
                        if (getFromTransferSlot().exists()) {
                            ...
                            moveItem(UIModItemCell.this, amount, true, true);
                        ...
                        //drag
                            ...
                            if (item != null) {
                                sendToTransferSlot(UIModItemCell.this, (byte) (item.stackCount / 2));
                            }
    ...
    public UIModItemCell(EntityRef owner, Vector2f size) {
     ...
     */
    public UIModItemCell(EntityRef owner, Vector2f size, Vector2f iconPosition) {
    ...
    */
    private static void moveItem(UIModItemCell targetCell, byte amount, boolean swap, boolean dropOnFail) {
     ...
     */
    private static boolean moveItemPlace(UIModItemCell targetCell, byte amount) {
        EntityRef item = getFromTransferSlot();
     ...
     */
    private static boolean moveItemMerge(UIModItemCell targetCell, byte amount) {
        EntityRef item = getFromTransferSlot();
        ItemComponent sourceItem = item.getComponent(ItemComponent.class);
        InventoryComponent targetInventory = targetCell.getOwnerEntity().getComponent(InventoryComponent.class);
     ...
     * @param targetCell The target cell to move the item to.
     */
    private static boolean moveItemSwap(UIModItemCell targetCell) {
        EntityRef item = getFromTransferSlot();
        ItemComponent sourceItem = item.getComponent(ItemComponent.class);
     ...
     */
    private static void sendToTransferSlot(UIModItemCell sourceCell, byte amount) {
